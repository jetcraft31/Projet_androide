...
public :
    ...
    // Fonction rajouter afin de modifier la valeur de RegrowTimeMax

    void addRegrowTimeMax(int _value){regrowTimeMax= regrowTimeMax+ _value;}
    void setRegrowTimeMax(int _value){regrowTimeMax= _value;}
    int getRegrowTimeMax(){return regrowTimeMax;}
